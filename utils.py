...
class MultiCropWrapper(nn.Module):
    ...
    def forward(self, x, pos=None, mask_mode=None, abl=False):
        ...
        for end_idx in idx_crops:
            _out_global, _out_ref = self.backbone(torch.cat(x[start_idx: end_idx]), torch.cat(pos[start_idx:end_idx]) if pos is not None else None, mask_mode=mask_mode, abl=abl)
